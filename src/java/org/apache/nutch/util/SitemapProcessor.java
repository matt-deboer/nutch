...
import org.apache.nutch.util.hostdb.HostDatum;
import org.apache.nutch.util.hostdb.HostDb;
...
public class SitemapProcessor extends Configured implements Tool {
  ...
  public void sitemap(Path crawldb, Path hostdb, Path sitemapUrlDir, boolean strict, boolean filter,
    ...
    Job job = new Job(conf, "sitemap " + crawldb.toString());
    ...
    if (hostdb != null)
      MultipleInputs.addInputPath(job, new Path(hostdb, HostDb.CURRENT_NAME), SequenceFileInputFormat.class);
